...
@Component({
    ...
    <div class="wrap">
      <div class="login-shell">
        <aside class="brand-aside" aria-label="Marca">
          ...
          <p class="brand-sub">Peticiones, quejas, reclamos y sugerencias</p>
        </aside>
        ...
        <div class="panel">
          ...
          <p class="footer-note">
            Si tienes problemas para entrar, contacta al área de calidad o
  ...
  styles: [
    `
      ...
      .native-input::placeholder { color: #a1a9bb; }

      /* Chrome autofill → blanco dentro del wrapper, sin cajas internas */
      ...
      .right-icon:hover { background: #eef1f7; color: #0066CC; }
      .right-icon mat-icon {
      ...
      .submit:hover:not([disabled]) { background: #103847; }
